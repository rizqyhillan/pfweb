...
<div class="d-flex justify-content-between align-items-center mb-6">
  <h4 class="mb-0">Tambah Data Pasien (Hewan)</h4>
  <a href="{{ route('doctor.patients') }}" class="btn btn-secondary"><i class="bx bx-arrow-back me-1"></i> Kembali</a>
</div>
<div class="card"><div class="card-body">
  <form action="{{ route('doctor.patients.store') }}" method="POST" enctype="multipart/form-data">@csrf
    <div class="row mb-6">
    ...
    <div class="row mb-6">
      ...
      <div class="col-md-2"><label class="form-label">Umur (bln)</label><input type="number" class="form-control" name="umur" value="{{ old('umur') }}" placeholder="2" /></div>
