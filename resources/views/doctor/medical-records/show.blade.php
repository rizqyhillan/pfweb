...
<div class="row">
  <div class="col-md-8">
    ...
    <div class="card mb-6">
      <div class="card-header"><h5 class="card-title mb-0"><i class="bx bx-image me-2"></i>Foto Pemeriksaan</h5></div>
      <div class="card-body pt-4">
        <div class="d-flex flex-wrap gap-3">
          @foreach($medical_record->photos as $photo)
            <a href="{{ Storage::url($photo->foto) }}" target="_blank">
              <img src="{{ Storage::url($photo->foto) }}" class="rounded border" style="height: 150px; object-fit: cover; max-width: 100%;" alt="Foto">
            </a>
          @endforeach
        </div>
      </div>
  ...
  <div class="col-md-4"><div class="card"><div class="card-header"><h5 class="card-title mb-0">Info Hewan</h5></div><div class="card-body">
    @if($medical_record->hewan->foto)
      <div class="text-center mb-3">
        <img src="{{ Storage::url($medical_record->hewan->foto) }}" alt="Foto Hewan" class="rounded img-fluid" style="max-height: 200px; object-fit: cover;">
      </div>
    @endif
