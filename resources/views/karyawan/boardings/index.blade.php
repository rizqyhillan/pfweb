    ...
    <script>
      document.addEventListener('DOMContentLoaded', function () {
        if (typeof window.Echo !== 'undefined') {
          console.log('✅ Echo connected. Listening on boardings...');
                ...
                <tr style="animation: slideIn .3s ease; background-color: rgba(40, 199, 111, 0.05);">
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item" href="/karyawan/boardings/${b.id}/edit"><i class="icon-base bx bx-edit-alt me-1"></i> Edit</a>
                      </div>
                    </div>
                  </td>
                </tr>`;
