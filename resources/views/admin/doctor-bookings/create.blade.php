...
@section('title', 'Tambah Booking Dokter')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1 text-gray-800">Tambah Booking Dokter</h1>
            <p class="text-muted mb-0">Buat booking konsultasi dokter hewan baru.</p>
        </div>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <form action="{{ route('admin.doctor-bookings.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea 
                            ...
                            rows="3" 
                            class="form-control"
                            placeholder="Contoh: Hewan tidak mau makan, lemas, demam..."
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea 
                            ...
                            rows="3" 
                            class="form-control"
                            placeholder="Opsional, bisa diisi setelah konsultasi."
                        >{{ old('catatan_dokter') }}</textarea>
                    </div>
                </div>
