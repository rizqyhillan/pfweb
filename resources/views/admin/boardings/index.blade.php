...
<div class="d-flex justify-content-between align-items-center mb-6">
  ...
  <a href="{{ route('admin.boardings.create') }}" class="btn btn-primary"><i class="bx bx-plus me-1"></i> Boarding Baru</a>
</div>
  ...
  <div class="table-responsive text-nowrap">
    <table class="table">
      ...
      <tbody class="table-border-bottom-0">
          ...
          <td>
            <div class="dropdown">
              ...
              <div class="dropdown-menu">
                ...
                <form action="{{ route('admin.boardings.destroy', $boarding) }}" method="POST" onsubmit="return confirm('Yakin hapus data ini?')">
                  @csrf @method('DELETE')
        ...
        @empty
        <tr><td colspan="9" class="text-center text-muted py-4">Belum ada data boarding</td></tr>
        @endforelse
      </tbody>
    </table>
  </div>
