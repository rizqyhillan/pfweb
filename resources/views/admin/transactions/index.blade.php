  ...
  <div class="table-responsive text-nowrap">
    <table class="table">
      ...
      <tbody class="table-border-bottom-0">
          ...
          <td>
            <div class="dropdown">
              ...
              <div class="dropdown-menu">
                <form action="{{ route('admin.transactions.destroy', $trx) }}" method="POST" onsubmit="return confirm('Yakin hapus transaksi ini?')">
                  @csrf @method('DELETE')
        ...
        @empty
        <tr><td colspan="10" class="text-center text-muted py-4">Belum ada data transaksi</td></tr>
        @endforelse
      </tbody>
    </table>
  </div>
